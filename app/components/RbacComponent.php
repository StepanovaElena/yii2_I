...
class RbacComponent extends Component
{
    ...
    public function genRbac()
    {
        ...
        $createViewAllActivity->description = 'Просмотр и редактировани любых актвностей';
        ...
        $deleteActivity = $authManager->createPermission('deleteActivity');
        $deleteActivity->description = 'Удаление активности';
